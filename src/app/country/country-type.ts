...
export class Country {
	...
	//Static API
	public static init() {
		Country.fromName.set(
			'Germany',
			new Country('Germany', -960.0, -1088.0, Cities[0], Cities[1], Cities[2], Cities[3], Cities[4], Cities[5])
		);
		...
		Country.fromName.set(
			'Greece',
			new Country('Greece', 5696.0, -9024.0, Cities[28], Cities[29], Cities[30], Cities[31])
		);
		Country.fromName.set('Bulgaria', new Country('Bulgaria', 6976.0, -6464.0, Cities[32], Cities[33]));
		Country.fromName.set(
			'Romania',
			new Country('Romania', 6080.0, -4288.0, Cities[34], Cities[35], Cities[36], Cities[37])
		);
		Country.fromName.set('Moldova', new Country('Moldova', 7744.0, -2880.0, Cities[38], Cities[39]));
		Country.fromName.set(
			'Ukraine',
			new Country('Ukraine', 8256.0, -1216.0, Cities[40], Cities[41], Cities[42], Cities[43], Cities[44], Cities[45])
		);
		Country.fromName.set(
			'Turkey',
			new Country(
		...
		Country.fromName.set(
			'Egypt',
			new Country('Egypt', 11072.0, -14912.0, Cities[66], Cities[67], Cities[68], Cities[69])
		);
		...
		Country.fromName.set(
			'Spain',
			new Country('Spain', -8896.0, -8384.0, Cities[84], Cities[85], Cities[86], Cities[87], Cities[88], Cities[89])
		);
		Country.fromName.set(
			'France',
			new Country(
		...
		Country.fromName.set(
			'Italy',
			new Country('Italy', -1088.0, -5568.0, Cities[100], Cities[101], Cities[102], Cities[103])
		);
		Country.fromName.set('Belgium', new Country('Belgium', -3648.0, -1856.0, Cities[104], Cities[105]));
		Country.fromName.set(
			'Netherlands',
			new Country('Netherlands', -3008.0, -448.0, Cities[106], Cities[107], Cities[108])
		);
		...
		Country.fromName.set(
			'Sweden',
			new Country('Sweden', 704.0, 7744.0, Cities[119], Cities[120], Cities[121], Cities[122], Cities[123])
		);
		Country.fromName.set(
			'Finland',
			new Country('Finland', 3648.0, 7744.0, Cities[124], Cities[125], Cities[126], Cities[127], Cities[128])
		);
		Country.fromName.set(
			'England',
			new Country('England', -6848.0, 832.0, Cities[129], Cities[130], Cities[131], Cities[132])
		);
		Country.fromName.set('Ireland', new Country('Ireland', -11584.0, 2112.0, Cities[133], Cities[134], Cities[135]));
		Country.fromName.set(
			'Iceland',
			new Country('Iceland', -7360.0, 9664.0, Cities[136], Cities[137], Cities[138], Cities[139])
		);
		...
		Country.fromName.set(
			'Belarus',
			new Country('Belarus', 6336.0, 1216.0, Cities[150], Cities[151], Cities[152], Cities[153])
		);
		...
		Country.fromName.set(
			'Disko Bay',
			new Country('Disko Bay', -11072.0, 14272.0, Cities[169], Cities[170], Cities[171])
		);
		...
		Country.fromName.set(
			'Southern Russia',
			new Country('Southern Russia', 15936.0, -320.0, Cities[186], Cities[187], Cities[188], Cities[189], Cities[190])
		);
		Country.fromName.set('Volga', new Country('Volga', 17088.0, 5184.0, Cities[191], Cities[192], Cities[193]));
		Country.fromName.set(
			'Central Russia',
			new Country('Central Russia', 11584.0, 3392.0, Cities[194], Cities[195], Cities[196], Cities[197], Cities[198])
		);
		...
		Country.fromName.set(
			'National Park',
			new Country('National Park', -8640.0, 14400.0, Cities[203], Cities[204], Cities[205])
		);
