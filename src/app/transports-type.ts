...
// 	// 		Transports.loadedUnits.set(
// 	// 			trans,
// 	// 			Transports.loadedUnits.get(trans).filter((unit) => unit !== unloadedUnit)
// 	// 		);
...
// 		Transports.loadedUnits.set(
// 			trans,
// 			Transports.loadedUnits.get(trans).filter((unit) => IsUnitInTransport(unit, trans))
// 		);
