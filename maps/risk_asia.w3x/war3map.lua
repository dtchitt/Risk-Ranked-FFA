...
u = BlzCreateUnitWithSkin(p, FourCC("h000"), 8128.0, -10752.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h001"), 8736.0, -9120.0, 270.000, FourCC("h001"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), 8633.2, -9796.0, 270.000, FourCC("h004"))
end
