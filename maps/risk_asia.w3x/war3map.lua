...
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -10752.0, 10880.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -10624.0, 9792.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -8256.0, 9792.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -6528.0, 6976.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -5120.0, 6976.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -7040.0, 8832.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -7616.0, 7488.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -7879.1, 8764.8, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -5824.1, 6967.5, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -9792.0, 8576.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -10368.0, 7424.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -8576.0, 6528.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -9412.8, 7862.0, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -10179.3, 10297.9, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -5184.0, 8512.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -4096.0, 7808.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -3264.0, 8896.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -4300.1, 8511.7, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -10944.0, 13376.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -9216.0, 13312.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -8320.0, 12160.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -9792.0, 11904.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -10058.4, 12853.0, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -5888.0, 9920.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -3520.0, 10240.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -2624.0, 12544.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -5248.0, 11712.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -7040.0, 13376.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -5248.0, 14208.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -5179.3, 12858.3, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -13412.0, -14342.2, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -13055.0, -14696.1, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -12892.3, -14793.0, 270.000, FourCC("h004"))
end
