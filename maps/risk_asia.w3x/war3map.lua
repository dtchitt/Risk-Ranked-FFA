...
u = BlzCreateUnitWithSkin(p, FourCC("h000"), 4736.0, -2368.0, 270.000, FourCC("h000"))
...
u = BlzCreateUnitWithSkin(p, FourCC("h001"), -2208.0, -10976.0, 270.000, FourCC("h001"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -3072.0, -9664.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -2755.6, -10307.6, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -11264.0, 15232.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -9856.0, 14976.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -9088.0, 16000.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -12352.0, 7872.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -13312.0, 8320.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -5952.0, 960.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -12544.0, 9088.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -5120.0, 128.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -6144.0, -704.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -7168.0, 6912.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -5056.0, 6848.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -12995.7, 15413.4, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -10053.0, 12859.3, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -10181.0, 15799.3, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -4800.0, -6272.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -12739.6, 8506.1, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -3328.0, -6272.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -3968.0, -7296.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -4544.0, 4672.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -4096.0, 3520.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -3456.0, 2432.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -4608.0, 1472.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -3456.0, 576.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -2112.0, -128.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -2880.0, -1664.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), 1984.0, -704.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), 3008.0, -960.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h001"), 288.0, -1440.0, 270.000, FourCC("h001"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -192.0, -320.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), 56.5, -840.3, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), 1600.0, -1664.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), 2112.0, -2624.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -7232.0, 1216.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -8192.0, 1920.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -7168.0, 2816.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -5504.0, 3072.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -7296.0, 4096.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -8640.0, 3904.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -8064.0, 5312.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -6656.0, 5568.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h001"), -11552.0, 1632.0, 270.000, FourCC("h001"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -10432.0, 2816.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -11776.0, 3200.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -12352.0, 4736.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -9984.0, 4224.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -10880.0, 5504.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -11199.0, 4403.2, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -9728.0, 8448.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -8768.0, 7296.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -8512.0, 9728.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h000"), -7552.0, 8320.0, 270.000, FourCC("h000"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -6983.9, 1979.1, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -3529.0, -2504.1, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), -4162.9, -4936.0, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), 2489.4, -1988.1, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), 5687.3, -841.1, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), 4532.9, -1605.4, 270.000, FourCC("h004"))
u = BlzCreateUnitWithSkin(p, FourCC("h004"), 6451.5, -5698.8, 270.000, FourCC("h004"))
end
...
DefineStartLocation(0, 192.0, 1088.0)
DefineStartLocation(1, 192.0, 1088.0)
DefineStartLocation(2, 192.0, 1088.0)
DefineStartLocation(3, 192.0, 1088.0)
DefineStartLocation(4, 192.0, 1088.0)
DefineStartLocation(5, 192.0, 1088.0)
DefineStartLocation(6, 192.0, 1088.0)
DefineStartLocation(7, 192.0, 1088.0)
DefineStartLocation(8, 192.0, 1088.0)
DefineStartLocation(9, 192.0, 1088.0)
DefineStartLocation(10, 192.0, 1088.0)
DefineStartLocation(11, 192.0, 1088.0)
DefineStartLocation(12, 192.0, 1088.0)
DefineStartLocation(13, 192.0, 1088.0)
DefineStartLocation(14, 192.0, 1088.0)
DefineStartLocation(15, 192.0, 1088.0)
DefineStartLocation(16, 192.0, 1088.0)
DefineStartLocation(17, 192.0, 1088.0)
DefineStartLocation(18, 192.0, 1088.0)
DefineStartLocation(19, 192.0, 1088.0)
DefineStartLocation(20, 192.0, 1088.0)
DefineStartLocation(21, 192.0, 1088.0)
DefineStartLocation(22, 192.0, 1088.0)
